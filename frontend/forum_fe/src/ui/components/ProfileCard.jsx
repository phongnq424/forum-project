    ...
    <div className="bg-white/10 rounded-4xl py-4 px-10 w-full mx-auto text-white">
      <div className="flex items-center justify-between space-x-6">
        ...
        <div className="w-full space-y-2">
          ...
          <button className="min-w-fit mt-5 bg-secondary w-fit hover:shadow-[0_0_10px_var(--color-proPurple)] text-lg gap-2 flex border-2 border-white/10 px-5 py-1 rounded-xl items-center shadow-[0_0_10px_rgba(255,255,255,50)]">
