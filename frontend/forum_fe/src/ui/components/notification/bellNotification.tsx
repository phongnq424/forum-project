...
import LoadingScreen from "@/ui/pages/LoadingScreen.jsx";
        ...
        >
          ...
          <div className="border-t border-border/50 px-4 py-2.5">
            <button
              ...
              className="w-full text-center text-sm font-medium text-white hover:text-proPurple transition-colors py-1 outline:none focus:ring-0"
            >
